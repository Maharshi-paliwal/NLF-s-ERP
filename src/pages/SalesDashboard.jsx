...
//         // -----------------------------
//         // 1) Fetch salesperson master
//         // -----------------------------
//         const spRes = await fetch(`${API_BASE}/sale_person_list`, {
//           method: "GET",
//         });
...
//           try {
//             // Fetch client data for this lead
...
//             // Check if client data fetch was successful
//             if (clientData?.status && clientData.success === "1" && clientData.data) {
//               // Get employee ID from client data
...
//             // Use visiting_date from lead_list as last interaction
...
//             // Add lead without salesperson mapping if fetch fails
//             const visitDateNormalized = normalizeApiDate(lead.visiting_date || "");
//             const reminderDate = calculateReminderDate(visitDateNormalized);
//             const countdownDays = getCountdownDays(reminderDate);
...
//           </div>
//           <div className="stat-content">
//             <div className="stat-label">Active Salespeople</div>
//             <div className="stat-value">{statistics.activeSalespeople}</div>
...
//           {currentItems.map((sp) => (
//             <div key={sp.emp_id} className="person-card">
//               <div className="person-name">{sp.name}</div>
//               <div className="client-count">
//                 Clients: {salespersonClientCounts[String(sp.emp_id)] || 0}
//               </div>
//               <div className="person-actions">
//                 <button
//                   className="buttonEye text-light"
//                   onClick={() =>
//                     handleViewSalespersonClients(sp.emp_id, sp.name)
//                   }
//                   title="View Details"
//                 >
//                   <FaEye />
