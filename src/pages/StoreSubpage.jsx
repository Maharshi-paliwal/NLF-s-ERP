// // StoreSubpage.jsx – DesignSubpage PARITY VERSION
...
//       const alloc = Number(allocated[index] || 0);
...
//         unit: mat.unit,
//         required,
//         available: required, // same assumption as Design
...
//     mrpRows.length > 0 && mrpRows.every((r) => r.isLocked);

//   const handleAllocationChange = (id, value) => {
//     const v = value === "" ? 0 : Number(value);
//     if (!isNaN(v)) {
//       setAllocated((prev) => ({ ...prev, [id]: v }));
//     }
//   };
...
//       const payload = {
//         material: mrpRows.map((m) => ({
//           raw_material: m.rawMaterial,
//           unit: m.unit,
//           required: m.required,
...
//         toast.success("MRP released to Planning");
//       } else {
...
//       <Button as={Link} to="/store" className="add-customer-btn mb-4">
//         <FaArrowLeft />
//       </Button>
...
//         <Row className="p-4">
//           <Col>
//             <h2>Store Team – Material Planning</h2>
//             <p className="text-muted mb-0">
//               Source: <strong>Material Master</strong>
//             </p>
//           </Col>
//         </Row>
//       </Card>
...
//                       value={row.allocated || ""}
//                       onChange={(e) =>
//                         handleAllocationChange(row.id, e.target.value)
//                       }
...
//           >
//             {isProcessing ? "Processing…" : "Release MRP to Planning"}
//           </Button>
//         </Card.Footer>
//       </Card>
//     </Container>
  ...
  return (
    <Container fluid className="p-4">
      ...
      <Card className="mb-4 shadow-sm">
        <Row className="p-4">
          <Col>
            <h2>Store Team – Material & Product Planning</h2>
            <p className="text-muted mb-0">
