// PlanningSubpage.jsx – DesignSubpage PARITY VERSION
...
export default function PlanningSubpage() {
  ...
  return (
    <Container fluid className="p-4">
      <Button as={Link} to="/plannings" className="add-customer-btn mb-4">
      ...
      <Card className="mb-4 shadow-sm">
        <Row className="p-4">
          <Col>
            <h2>Planning Team – Material & Product Planning</h2>
